...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [-21995.345717, 6600301.548279, 9199.777181, 6615336.472241], maxZoom: 28, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:3857',
            //extent: [-334639.964922, 6572293.454072, 97488.531684, 7139982.358905],
            units: 'm'})
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([-21995.345717, 6600301.548279, 9199.777181, 6615336.472241], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Plumpton and East Chiltington Living Landscapes Map</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (1403 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Welcome to the Plumpton and East Chiltington Living Landscapes Map! This map supplies information on the habitat types, rivers, ancient trees and walking routes of Plumpton and East Chiltington, and species records data of Plumpton. Use the + and - buttons to zoom in or out, the ruler to measure distances, and the search button to search for addresses! All layers are shown in the legend on the right-hand side; turn them on or off as you like. All information about an area or feature is displayed by clicking it.<br /><br />In cases where a species group (for example, an invertebrate) was recorded but the species remains unknown, the feature may simply be listed as "damselfly" or "spider". <br />In habitats where further information about them is available (such as woodland names or grassland types) this can be accessed by clicking the habitat. <br /><br />East Sussex Rights of Way data supplied by East Sussex County Council GIS Open Data, https://www.nationalarchives.gov.uk/doc/open-government-licence/version/3/<br />Species data supplied by Sussex Biodiversity Record Centre.<br />National Forest Inventory England 2023. Contains, or is based on, information supplied by the Forestry Commission. <br />Based upon LCM2024 © UKCEH 2025<br />Maps are from OS MasterMap Topography. <br />Contains public sector information licensed under the Open Government Licence v3.0. and Ordnance Survey data © Crown copyright and database right 2024.<br /><br />';
            }
